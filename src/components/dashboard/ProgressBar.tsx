...
export const ProgressCircleHero = () => (
  <div className="space-y-3">
    ...
    <Card className="mx-auto max-w-sm space-y-4">
      <h1 className="text-center font-mono text-sm text-slate-700 dark:text-slate-100">
      ...
      <div className="flex justify-start space-x-5 items-center">
        ...
        <div>
          ...
          <p className="text-tremor-default text-tremor-content dark:text-dark-tremor-content-strong">
